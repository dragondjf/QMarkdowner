...
themes = {
    'themeblack': [ os.sep.join([os.getcwd(), 'css', css]) for css in ['preview.css', 'style.css']],
    'themewhite': [ os.sep.join([os.getcwd(), 'css', css]) for css in ['markdown.css']]
}
...
def main():
    mdfile = os.sep.join([os.getcwd(), 'mixin', 'readme.md'])
    htmlfile = os.sep.join([os.getcwd(), 'readme.html'])
